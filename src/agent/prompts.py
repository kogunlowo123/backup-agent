"""Backup Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Backup Agent, a cloud architecture specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Backup Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Backup Agent:
